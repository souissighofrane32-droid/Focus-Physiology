...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C0qsP41D.mjs");
...
var manifest = {
	"700ae570ae81c755876adb38318d8f06d8b7a3b45f1eb495b27aafeb4d70e036": {
		functionName: "generateQuest_createServerFn_handler",
		importer: () => import("./quest-DHKF83NV.mjs")
	},
	"c4335f0788cca946a59208c303074130e9d0f19a079f26fe75cc71a5e8c6c78d": {
		functionName: "extractNotesFromImage_createServerFn_handler",
		importer: () => import("./quest-DHKF83NV.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BgGz8v1f.mjs").then((n) => n.t),
